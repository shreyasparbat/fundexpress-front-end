...
const pawnTickets = {dataSource: [
  {
    ...
    ticketNumber: '201011',
    dateCreated: new Date('2017-09-23'),
    expiryDate: new Date('2018-02-22'),
    interestPayable: '82',
    offeredValue: '1000',
    specifiedValue: '999',
  ...
  },
  {
    ...
    itemName: 'ROLEX Datejust Automatic Gold Dial 18kt Yellow Gold Watch',
    ticketNumber: '201012',
    dateCreated: new Date('2017-03-21'),
    expiryDate: new Date('2017-09-21'),
    interestPayable: '82',
    offeredValue: '1000',
    specifiedValue: '999',
    approvalStatus: 'approved'
  },
  {
    ...
    itemName: 'ROLEX Datejust Automatic Gold Dial 18kt Yellow Gold Watch',
    ticketNumber: '201013',
    dateCreated: new Date('2017-03-11'),
    expiryDate: new Date('2017-09-11'),
    interestPayable: '82',
    offeredValue: '1000',
    specifiedValue: '999',
    approvalStatus: 'approved'
